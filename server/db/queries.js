...
AND pl.language_id = ?
  ...
  getAllCharacteristicsByCategoryUrl: `
    SELECT prpv2.property_id, pl2.name FROM product_rel_property_value prpv2
  ...
  SELECT pvl3.property_value_id, pvl3.name, prpv3.property_id FROM product_rel_property_value prpv3
